...
const EVENT_COUNTER: Item<u64> = Item::new("event_counter_v24");
...
pub fn event_store<'a>() -> IndexedMap<'a, u64, Event, EventIndexes<'a>> {
    let indexes = EventIndexes {
        resource_id: UniqueIndex::new(|e| (e.resource_id.into(), e.id), "events_v24__resource_id"),
    };
    IndexedMap::new("events_v24", indexes)
}
...
pub fn serialised_event_store<'a>() -> IndexedMap<'a, u64, Binary, SerialisedEventIndexes<'a>> {
    let indexes = SerialisedEventIndexes {
        resource_id: UniqueIndex::new(
            ...
            "serialised_events_v24__resource_id",
        ),
    };
    IndexedMap::new("serialised_events_v24", indexes)
}
