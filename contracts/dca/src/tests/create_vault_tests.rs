...
//                 destinations: None,
//                 pool_id: mock.fin_contract_address.clone(),
//                 position_type: None,
...
//     assert_eq!(vault_response.vault.pool.address, mock.fin_contract_address);
// }
...
//                 label: Some("label".to_string()),
//                 destinations: None,
//                 pool_id: Addr::unchecked("not-a-pair-address".to_string()),
//                 position_type: None,
//                 slippage_tolerance: None,
//                 swap_amount,
//                 time_interval: TimeInterval::Hourly,
