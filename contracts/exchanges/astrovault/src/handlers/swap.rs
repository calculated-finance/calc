...
use astrovault::router::{
    handle_msg::{ExecuteMsg, RouterReceiveMsg},
    state::HopV2,
};
use cosmwasm_std::{
...
pub fn swap_handler(
    ...
    let swap_msg = to_json_binary(&ExecuteMsg::Receive(Cw20ReceiveMsg {
    ...
    Ok(Response::new()
        ...
        .add_submessage(SubMsg::reply_on_success(
            into_execute_msg(deps.api, config.router_address, swap_msg, swap_amount)?,
            AFTER_SWAP,
        )))
}
...
mod swap_tests {
    ...
    use crate::{
        ...
        tests::constants::{ADMIN, DENOM_UATOM, DENOM_UOSMO, DENOM_UUSDC, ROUTER},
        types::config::Config,
        ContractError,
    };
    ...
    fn caches_details_correctly() {
        ...
        let minimum_receive_amount = Coin::new(3873213, DENOM_UUSDC);

        let route = vec![HopV2::StandardHopInfo {
        ...
        assert_eq!(
            ...
            &SubMsg {
                msg: CosmosMsg::Wasm(WasmMsg::Execute {
                    ...
                    msg: to_json_binary(&ExecuteMsg::Receive(Cw20ReceiveMsg {
