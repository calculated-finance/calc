...
export const fetchConfig = async (): Promise<Config> => {
  ...
  if (process.env.ADMIN_CONTRACT_ADDRESS === undefined) {
    throw new Error('Missing ADMIN_CONTRACT_ADDRESS environment variable');
  }
  ...
  return {
    ...
    adminContractAddress: process.env.ADMIN_CONTRACT_ADDRESS,
  };
};
